  ...
  for(const [name, config] of Object.entries(configs)) {
    if(config.verifier) {
      ...
      describe(`Verifier: ${name}`, function() {
        it(`MUST verify a Verifiable Presentation where the presentation's
            holder and the credential's subject are different.`,
        async function() {
        ...
        it(`MUST verify a Verifiable Presentation where the presentation's
            holder and the credential's subject are the same.`,
        async function() {
